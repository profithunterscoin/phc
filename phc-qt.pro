# *****************************************************
# PHC-QT (GUI WALLET) (Bitcoin Core 8)
#
# Copyright (c) 2009-2010 Satoshi Nakamoto
# Copyright (c) 2009-2012 The Bitcoin developers
# Copyright (c) 2018 Profit Hunters Coin
#
...
QMAKE_CXXFLAGS *= -fstack-protector-all --param ssp-buffer-size=1 -Wdeprecated-declarations
QMAKE_LFLAGS *= -fstack-protector-all --param ssp-buffer-size=1 -Wdeprecated-declarations
...
# removes the auto_ptr warnings
QMAKE_CXXFLAGS *= -Wno-deprecated-declarations
QMAKE_LFLAGS *= -Wno-deprecated-declarations
...
macx:ICON = src/qt/res/icons/phc.icns
macx:TARGET = "PHC-Qt"
