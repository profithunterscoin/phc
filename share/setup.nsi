...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER PHC
#!define MUI_FINISHPAGE_RUN $INSTDIR\phc-qt.exe
...
Section -Main SEC0000
    ...
    #Delete /REBOOTOK $INSTDIR\phc-qt.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall PHC.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall PHC.lnk"
