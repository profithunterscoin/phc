...
// Calculate new Height Average from all peers connected
    ...
    if (pnode->nRecvBytes > 0)
    {
        ...
        {   
            ...
            CurrentAverageSend = CurrentAverageSend + pnode->nSendBytes / ClientModel::getNumConnections();
            CurrentAverageRecv = CurrentAverageRecv + pnode->nRecvBytes / ClientModel::getNumConnections();
