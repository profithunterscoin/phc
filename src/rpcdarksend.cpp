...
Value SendMoney(const CTxDestination &address, CAmount nValue, CWalletTx& wtxNew, AvailableCoinsType coin_type=ALL_COINS)
{
    string strError;
...
Value darksend(const Array& params, bool fHelp)
{
    ...
    /** TO FIX
    string strError = SendMoney(address.Get(), nAmount, wtx, ONLY_DENOMINATED);
