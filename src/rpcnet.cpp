...
Value getaddednodeinfo(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("getaddednodeinfo <dns> [node]\n"
...
Value sendalert(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("sendalert <message> <privatekey> <minver> <maxver> <priority> <id> [cancelupto]\n"
...
Value getnettotals(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 0)
    {
        throw runtime_error("getnettotals\n"
...
{
    // TODO: Upgrade to std::list<std::string>   FIREWALL_WHITELIST.push_back() 
...
{
    // TODO: Upgrade to std::list<std::string>   FIREWALL_BLACKLIST.push_back() 
...
{
    // TODO: Upgrade to std::list<std::string> std::list<int>   FIREWALL_FLOODPATTERNS.push_back() 
...
{
    // TODO: Upgrade to std::list<std::string> std::list<int>   FIREWALL_FLOODPATTERNS.pop_back() 
