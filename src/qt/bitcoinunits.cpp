...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PHC");
    case mBTC: return QString("mPHC");
    case uBTC: return QString::fromUtf8("μPHC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PHCs");
    case mBTC: return QString("Milli-PHCs (1 / 1,000)");
    case uBTC: return QString("Micro-PHCs (1 / 1,000,000)");
    default: return QString("???");
    }
}
