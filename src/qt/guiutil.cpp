...
namespace GUIUtil
{
    ...
    bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
    {
        ...
        if(uri.startsWith("PHC://", Qt::CaseInsensitive))
        {
            uri.replace(0, 11, "PHC:");
        }
    ...
    */
    ...
    {
        return GetSpecialFolderPath(CSIDL_STARTUP) / "PHC.lnk";
    }
    ...
    {
        return GetAutostartDir() / "PHC.desktop";
    }
    ...
    bool SetStartOnSystemStartup(bool fAutoStart)
    {
        ...
        else
        {
            ...
            // Write a PHC.desktop file to the autostart directory:
    ...
    LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
    {
        // loop through the list of startup items and try to find the PHC app
    ...
    bool SetStartOnSystemStartup(bool fAutoStart)
    {
        ...
        {
            // add PHC app to startup item list
    ...
    {
        header = tr("PHC-Qt") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion()) + "\n\n" +
            tr("Usage:") + "\n" + "  PHC-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    void SetBlackThemeQSS(QApplication& app)
    {
        app.setStyleSheet("QWidget"
                            ...
                            "{"
                            "   background: rgb(30,32,36);"
                            "   color: rgb(116,122,134);"
                            "   border: none;"
                            "   border-left-color: rgb(30,32,36);"
                            ...
                            "    color: rgb(255,255,255);"
                            "    border: none;"
                            "    border-left-color: rgb(215,173,94);"
                            "    border-left-style: solid;"
                            "    border-left-width: 6px;"
                            "}"
                            "QProgressBar"
                            ...
                            "QTableView"
                            "{"
                            "    background: rgb(66,71,78);"
                            "    color: rgb(212,213,213);"
                            "    gridline-color: rgb(157,160,165);"
                            "}"
                            "QHeaderView::section"
                            "{"
