...
SendMessagesDialog::SendMessagesDialog(Mode mode, Type type, QWidget *parent) : QDialog(parent), ui(new Ui::SendMessagesDialog), model(0), mode(mode), type(type)
{
    ...
    {
        ui->addressFrom->setPlaceholderText(tr("Enter a PHC address (e.g. P8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
    }
...
void SendMessagesDialog::on_sendButton_clicked()
{
    ...
    switch(sendstatus)
    {
        ...
        {
            QMessageBox::warning(this, tr("Send Message"), tr("The recipient address is not valid, please recheck."), QMessageBox::Ok, QMessageBox::Ok);
        }
        break;
        
        case MessageModel::InvalidMessage:
        {
            QMessageBox::warning(this, tr("Send Message"), tr("The message can't be empty."), QMessageBox::Ok, QMessageBox::Ok);
        }
        break;
        
        case MessageModel::DuplicateAddress:
        {
            QMessageBox::warning(this, tr("Send Message"), tr("Duplicate address found, can only send to each address once per send operation."), QMessageBox::Ok, QMessageBox::Ok);
        }
        break;
        
        case MessageModel::MessageCreationFailed:
        {
            QMessageBox::warning(this, tr("Send Message"), tr("Error: Message creation failed."), QMessageBox::Ok, QMessageBox::Ok);
        }
        break;
        
        case MessageModel::MessageCommitFailed:
        {
            QMessageBox::warning(this, tr("Send Message"), tr("Error: The message was rejected."), QMessageBox::Ok, QMessageBox::Ok);
        }
        break;
        
        case MessageModel::Aborted:
        {
            // User aborted, nothing to do
        }
        break;
        
        case MessageModel::FailedErrorShown:
        {
            // Send failed, error message was displayed
        }
        break;
