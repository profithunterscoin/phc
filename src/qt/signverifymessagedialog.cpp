...
SignVerifyMessageDialog::SignVerifyMessageDialog(QWidget *parent) : QDialog(parent), ui(new Ui::SignVerifyMessageDialog), model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a PHC address (e.g. P8gZqgY4r2RoEskYk3QsAeFckyf9pRMN6i)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a PHC address (e.g. P8gZqgY4r2RoEskYk3QsAeFckyf9pRMN6i)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter PHC signature"));
#endif
