...
SendCoinsEntry::SendCoinsEntry(QWidget *parent) : QFrame(parent), ui(new Ui::SendCoinsEntry), model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a PHC address (e.g. P8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
#endif
...
SendCoinsRecipient SendCoinsEntry::getValue()
{
    ...
    if (rv.address.length() > 75 && IsStealthAddress(rv.address.toStdString()))
    {
