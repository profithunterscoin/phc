...
static void ThreadSafeMessageBox(const std::string& message, const std::string& caption, unsigned int style)
{
    ...
    if(guiref)
    {
        ...
        QMetaObject::invokeMethod(guiref, "message", modal ? GUIUtil::blockingGUIThreadConnection() : Qt::QueuedConnection, Q_ARG(QString, QString::fromStdString(caption)), Q_ARG(QString, QString::fromStdString(message)), Q_ARG(bool, modal), Q_ARG(unsigned int, style));
    }
    else
    {
        if (fDebug)
...
static bool ThreadSafeAskFee(int64_t nFeeRequired, const std::string& strCaption)
{
    ...
    QMetaObject::invokeMethod(guiref, "askFee", GUIUtil::blockingGUIThreadConnection(), Q_ARG(qint64, nFeeRequired), Q_ARG(bool*, &payFee));
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. PHC can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("Profit Hunters Coin");

    if(GetBoolArg("-testnet", false))
    {
        // Separate UI settings for testnet
        app.setApplicationName("PHC-Qt-testnet");
    } 
    else
    {
        app.setApplicationName("PHC-Qt");
    }
