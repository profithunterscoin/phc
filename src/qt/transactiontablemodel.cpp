...
TransactionTableModel::TransactionTableModel(CWallet* wallet, WalletModel *parent): QAbstractTableModel(parent), wallet(wallet), walletModel(parent), priv(new TransactionTablePriv(wallet, this))
{
...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    switch(wtx->type)
    {
        ...
        case TransactionRecord::SendToAddress: case TransactionRecord::SendToOther:
        {
            return tr("Sent to");
        }
        break;
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord *wtx, bool tooltip) const
{
    ...
    switch(wtx->type)
    {
        ...
        case TransactionRecord::SendToSelf: default:
        {
...
QVariant TransactionTableModel::txStatusDecoration(const TransactionRecord *wtx) const
{
    switch(wtx->status.status)
    {
        case TransactionStatus::OpenUntilBlock: case TransactionStatus::OpenUntilDate:
        {
        ...
        case TransactionStatus::MaturesWarning: case TransactionStatus::NotAccepted:
        {
            return QIcon(":/icons/transaction_0");
        }
        break;
...
struct TransactionNotification
{
    public:
        ...
        void invoke(QObject *ttm)
        {
            ...
            QMetaObject::invokeMethod(ttm, "updateTransaction", Qt::QueuedConnection, Q_ARG(QString, strHash), Q_ARG(int, status), Q_ARG(bool, showTransaction));
        }
