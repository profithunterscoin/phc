...
#define MASTERNODE_EXPIRATION_SECONDS          (12*60*60)
...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 10000 PHC, signature to prove
