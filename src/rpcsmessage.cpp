...
Value smsgenable(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("smsgenable \n"
...
Value smsgdisable(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
    {
        throw runtime_error("smsgdisable \n"
...
Value smsgoptions(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("smsgoptions [list|set <optname> <value>]\n"
...
Value smsglocalkeys(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
    {
        throw runtime_error("smsglocalkeys [whitelist|all|wallet|recv <+/-> <address>|anon <+/-> <address>]\n"
...
Value smsgscanchain(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
    {
        throw runtime_error("smsgscanchain \n"
...
Value smsgscanbuckets(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
    {
        throw runtime_error("smsgscanbuckets \n"
...
Value smsgaddkey(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("smsgaddkey <address> <pubkey>\n"
    ...
    if (rv != 0)
    {
        ...
        switch (rv)
        {
            case 2:
            {
                result.push_back(Pair("reason", "publicKey is invalid."));
            }
            break;
            
            case 3:
            {
                result.push_back(Pair("reason", "publicKey does not match address."));
            }
            break;
            
            case 4:
            {
                result.push_back(Pair("reason", "address is already in db."));
            }
            break;
            
            case 5:
            {
                result.push_back(Pair("reason", "address is invalid."));
            }
            break;
            
            default:
            {
                result.push_back(Pair("reason", "error."));
            }
            break;
        }
    }
...
Value smsggetpubkey(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("smsggetpubkey <address>\n"
...
Value smsgsend(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
    {
        throw runtime_error("smsgsend <addrFrom> <addrTo> <message>\n"
...
Value smsgsendanon(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
    {
        throw runtime_error("smsgsendanon <addrTo> <message>\n"
...
Value smsgoutbox(const Array& params, bool fHelp)
{
    ...
    {
        // defaults to read
        throw runtime_error("smsgoutbox [all|clear]\n" 
...
Value smsgbuckets(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
    {
        throw runtime_error("smsgbuckets [stats|dump]\n"
