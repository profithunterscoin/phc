...
public:
    CMainParams() {
        ...
        */
        ...
        vSeeds.push_back(CDNSSeedData("20",  "31.187.71.38"));
        vSeeds.push_back(CDNSSeedData("21",  "162.212.156.73"));
        vSeeds.push_back(CDNSSeedData("22",  "45.76.79.219"));
        vSeeds.push_back(CDNSSeedData("23",  "82.245.113.89"));
        vSeeds.push_back(CDNSSeedData("24",  "45.77.101.196"));
        vSeeds.push_back(CDNSSeedData("25",  "108.61.117.160"));
        vSeeds.push_back(CDNSSeedData("26",  "45.77.59.116"));
        vSeeds.push_back(CDNSSeedData("27",  "89.47.160.153"));
        vSeeds.push_back(CDNSSeedData("28",  "136.144.185.202"));
        vSeeds.push_back(CDNSSeedData("29",  "116.62.132.125"));
        vSeeds.push_back(CDNSSeedData("30",  "45.76.30.132"));
        vSeeds.push_back(CDNSSeedData("31",  "207.148.25.232"));
        vSeeds.push_back(CDNSSeedData("32",  "194.67.198.169"));
        vSeeds.push_back(CDNSSeedData("33",  "165.227.4.45"));
        vSeeds.push_back(CDNSSeedData("34",  "104.236.109.73"));
        vSeeds.push_back(CDNSSeedData("35",  "209.250.230.163"));
        vSeeds.push_back(CDNSSeedData("36",  "45.77.56.180"));
        vSeeds.push_back(CDNSSeedData("37",  "195.133.144.153"));
        vSeeds.push_back(CDNSSeedData("38",  "162.212.156.234"));
