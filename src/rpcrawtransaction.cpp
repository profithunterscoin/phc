...
Value listunspent(const Array& params, bool fHelp)
{
    ...
    if (params.size() > 2)
    {
        ...
        for(Value& input: inputs)
        {
            ...
            if (!address.IsValid())
            {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid PHC address: ")+input.get_str());
            }
    ...
    if (pwalletMain == NULL)
    {
        ...
        result.push_back(Pair("error", "pwalletMain == NULL"));
...
Value decoderawtransaction(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("decoderawtransaction <hex string>\n"
...
Value signrawtransaction(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("signrawtransaction <hex string> [{\"txid\":txid,\"vout\":n,\"scriptPubKey\":hex,\"redeemScript\":hex},...] [<privatekey1>,...] [sighashtype=\"ALL\"]\n"
    ...
    {
        static map<string, int> mapSigHashValues = boost::assign::map_list_of
...
Value sendrawtransaction(const Array& params, bool fHelp)
{
    ...
    {
        throw runtime_error("sendrawtransaction <hex string>\n"
