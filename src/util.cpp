...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PHC
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PHC
    // Mac: ~/Library/Application Support/PHC
    // Unix: ~/.PHC
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PHC";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "phc.conf"));
...
void ReadConfigFile(map<string, string>& mapSettingsRet, map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Create empty phc.conf if it does not exist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "phcd.pid"));
